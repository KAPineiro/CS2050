        ...
        public static void main(String[] args)
        {
            try
            {
                ...
                while ((line = br.readLine()) != null && index < 10000)
                {
                    ...
                    insertionSortStringArray[index] = str;
                ...
                long startTimeInsertionString = System.nanoTime();
                insertionSort(insertionSortStringArray);
                long endTimeInsertionString = System.nanoTime();
                long insertionSortTimeString = endTimeInsertionString - startTimeInsertionString;
                ...
                fw.write("Insertion Sort (Integer): " + insertionSortTime + " nanoseconds\n");
                ...
                fw.write("Insertion Sort (String): " + insertionSortTimeString + " nanoseconds\n");
                fw.close();
            } catch (IOException e) {
                e.printStackTrace();
            }
