// Kyle Pineiro
//Assignment #2 - Test file is completed make sure methods pass test in Program2.java
...
public class Program2Test {
    ...
    public void testBadSine() {
        assertEquals(1.37, Program2.sinOfAngle(4.1, 3), DELTA);
    }
    ...
    public void testBadHyp() {
        assertEquals(2.24, Program2.hypOfTriangle(1.0, 2.0), DELTA);
    }
}
